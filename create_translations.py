...
TRANSLATIONS = {
    ...
    # ── Izsoles detaļu lapa ──
    "Sākumcena" :                  {"ru": "Начальная цена",              "en": "Starting price",             "de": "Startpreis"},
    "solījumi":                    {"ru": "ставок",                      "en": "bids",                       "de": "Gebote"},
    "Aktīva":                      {"ru": "Активна",                     "en": "Active",                     "de": "Aktiv"},
    "beidzas":                     {"ru": "истекает",                    "en": "ends",                       "de": "endet"},
    "Anti-snipe pagarināts":       {"ru": "Анти-снайп продлён",          "en": "Anti-snipe extended",        "de": "Anti-Snipe verlängert"},
    "Anti-snipe aktīvs — pēdējo 60 sek. solījums pagarina izsoli par 3 min.":
                                   {"ru": "Анти-снайп активен — ставка в последние 60 сек. продлевает аукцион на 3 мин.",
                                    "en": "Anti-snipe active — a bid in the last 60 sec. extends the auction by 3 min.",
                                    "de": "Anti-Snipe aktiv — ein Gebot in den letzten 60 Sek. verlängert die Auktion um 3 Min."},
    "Jūsu rezerves cena":          {"ru": "Ваша резервная цена",         "en": "Your reserve price",         "de": "Ihr Mindestpreis"},
    "redzat tikai jūs":            {"ru": "видите только вы",            "en": "only you can see this",      "de": "nur Sie sehen dies"},
    "Manuāli":                     {"ru": "Вручную",                     "en": "Manual",                     "de": "Manuell"},
    "Automātiski":                 {"ru": "Автоматически",               "en": "Automatic",                  "de": "Automatisch"},
    "Min. solījums":               {"ru": "Мин. ставка",                 "en": "Min. bid",                   "de": "Mindestgebot"},
    "Soļu tabula":                 {"ru": "Шаги ставок",                 "en": "Bid step table",             "de": "Gebotsschritte"},
    "Solis":                       {"ru": "Шаг",                         "en": "Step",                       "de": "Schritt"},
    "Automātiskā solīšana aktīva": {"ru": "Автоставка активна",          "en": "Auto-bid active",            "de": "Autogebot aktiv"},
    "Jūsu maksimums":              {"ru": "Ваш максимум",                 "en": "Your maximum",               "de": "Ihr Maximum"},
    "Mans maksimums":              {"ru": "Мой максимум",                 "en": "My maximum",                 "de": "Mein Maximum"},
    "Sistēma automātiski solīs jūsu vietā ar minimālo soli. Jūsu maksimums ir slēpts no citiem.":
                                   {"ru": "Система автоматически сделает ставку вместо вас с минимальным шагом. Ваш максимум скрыт от других.",
                                    "en": "The system will automatically bid on your behalf with the minimum increment. Your maximum is hidden from others.",
                                    "de": "Das System bietet automatisch mit dem Mindestbetrag für Sie. Ihr Maximum ist für andere verborgen."},
    "Atjaunināt automātisko solīšanu": {"ru": "Обновить автоставку",     "en": "Update auto-bidding",        "de": "Autogebot aktualisieren"},
    "Uzstādīt automātisko solīšanu":   {"ru": "Установить автоставку",   "en": "Set auto-bidding",           "de": "Autogebot festlegen"},
    "Nevarat solīt savā izsolē.":  {"ru": "Нельзя делать ставки в своём аукционе.", "en": "Cannot bid on your own auction.", "de": "Sie können nicht in Ihrer eigenen Auktion bieten."},
    "Izsole ir noslēgusies.":      {"ru": "Аукцион завершён.",           "en": "The auction has ended.",     "de": "Die Auktion ist beendet."},
    ...
    # ── Publicēt sludinājumu (create.html) ──
    "— Izvēlieties kategoriju —":  {"ru": "— Выберите категорию —",      "en": "— Select category —",        "de": "— Kategorie wählen —"},
    "— Izvēlieties apakškategoriju —": {"ru": "— Выберите подкатегорию —", "en": "— Select subcategory —",   "de": "— Unterkategorie wählen —"},
    "— Izvēlieties modeli —":      {"ru": "— Выберите модель —",          "en": "— Select model —",           "de": "— Modell wählen —"},
    "— Izvēlieties —":             {"ru": "— Выберите —",                 "en": "— Select —",                 "de": "— Auswählen —"},
    "— Nav norādīts —":            {"ru": "— Не указано —",               "en": "— Not specified —",          "de": "— Nicht angegeben —"},
    "Izgatavošanas gads":          {"ru": "Год выпуска",                  "en": "Year of manufacture",        "de": "Baujahr"},
    "Sāciet rakstīt adresi...":    {"ru": "Начните вводить адрес...",     "en": "Start typing address...",    "de": "Adresse eingeben..."},
    "Lūdzu izvēlieties adresi no saraksta.": {"ru": "Пожалуйста, выберите адрес из списка.", "en": "Please select an address from the list.", "de": "Bitte wählen Sie eine Adresse aus der Liste."},
    "Spied vai velc bildes šeit":  {"ru": "Нажмите или перетащите фото сюда", "en": "Click or drag photos here", "de": "Fotos hier klicken oder ziehen"},
    "JPG, PNG, WEBP · max 8 bildes": {"ru": "JPG, PNG, WEBP · макс. 8 фото", "en": "JPG, PNG, WEBP · max 8 photos", "de": "JPG, PNG, WEBP · max. 8 Fotos"},
    "Spied vai velc video šeit":   {"ru": "Нажмите или перетащите видео сюда", "en": "Click or drag video here", "de": "Video hier klicken oder ziehen"},
    "MP4, WEBM, MOV · max 1 video": {"ru": "MP4, WEBM, MOV · макс. 1 видео", "en": "MP4, WEBM, MOV · max 1 video", "de": "MP4, WEBM, MOV · max. 1 Video"},
    "Transportlīdzekļa dati":      {"ru": "Данные транспортного средства", "en": "Vehicle details",           "de": "Fahrzeugdaten"},
    "Obligāti lauki":              {"ru": "Обязательные поля",            "en": "Required fields",            "de": "Pflichtfelder"},
    "Motora tips":                 {"ru": "Тип двигателя",                "en": "Engine type",                "de": "Motortyp"},
    "Motora tilpums (L)":          {"ru": "Объём двигателя (л)",          "en": "Engine volume (L)",          "de": "Motorvolumen (L)"},
    "Virsbūves tips":              {"ru": "Тип кузова",                   "en": "Body type",                  "de": "Karosserietyp"},
    "Nobraukums (km)":             {"ru": "Пробег (км)",                  "en": "Mileage (km)",               "de": "Kilometerstand (km)"},
    "Reģ. numurs":                 {"ru": "Рег. номер",                   "en": "Reg. number",                "de": "Kfz-Kennzeichen"},
    "VIN kods":                    {"ru": "VIN код",                      "en": "VIN code",                   "de": "VIN-Code"},
    "Ir tehniskā apskate":         {"ru": "Есть технический осмотр",      "en": "Has technical inspection",   "de": "Hat TÜV"},
    "Tehniskā apskate līdz":       {"ru": "Технический осмотр до",        "en": "Inspection valid until",     "de": "TÜV gültig bis"},
    "Riepas parametri":            {"ru": "Параметры шин",                "en": "Tire parameters",            "de": "Reifenparameter"},
    "* — obligāti lauki":          {"ru": "* — обязательные поля",        "en": "* — required fields",        "de": "* — Pflichtfelder"},
    "Rādiuss (collas)":            {"ru": "Радиус (дюймы)",               "en": "Radius (inches)",            "de": "Radius (Zoll)"},
    "Platums (mm)":                {"ru": "Ширина (мм)",                  "en": "Width (mm)",                 "de": "Breite (mm)"},
    "Profils (%)":                 {"ru": "Профиль (%)",                  "en": "Profile (%)",                "de": "Profil (%)"},
    "Ātruma indekss":              {"ru": "Индекс скорости",              "en": "Speed index",                "de": "Geschwindigkeitsindex"},
    "Nekustamā īpašuma dati":      {"ru": "Данные о недвижимости",        "en": "Property details",           "de": "Immobilienangaben"},
    "Rajons":                      {"ru": "Район",                        "en": "District",                   "de": "Bezirk"},
    "Aprīkojums":                  {"ru": "Оснащение",                    "en": "Equipment",                  "de": "Ausstattung"},
    "Atzīmējiet visu pieejamo aprīkojumu": {"ru": "Отметьте всё доступное оснащение", "en": "Check all available equipment", "de": "Alle verfügbare Ausstattung markieren"},
    "Publicēt kā izsoli":          {"ru": "Опубликовать как аукцион",     "en": "Post as auction",            "de": "Als Auktion einstellen"},
    "Sākuma cena (€)":             {"ru": "Начальная цена (€)",           "en": "Starting price (€)",         "de": "Startpreis (€)"},
    "Solījuma solis tiek aprēķināts automātiski pēc cenas.": {"ru": "Шаг ставки рассчитывается автоматически по цене.", "en": "Bid increment is calculated automatically based on the price.", "de": "Der Gebotsschritt wird automatisch anhand des Preises berechnet."},
    "Izsole beidzas":              {"ru": "Аукцион заканчивается",        "en": "Auction ends",               "de": "Auktion endet"},
    "Minimums: 1 stunda. Maksimums: 1 mēnesis.": {"ru": "Минимум: 1 час. Максимум: 1 месяц.", "en": "Minimum: 1 hour. Maximum: 1 month.", "de": "Minimum: 1 Stunde. Maximum: 1 Monat."},
    "Pērc tūlīt cena (€)":         {"ru": "Цена «Купить сейчас» (€)",    "en": "Buy now price (€)",          "de": "Sofortkauf-Preis (€)"},
    "— nav obligāta":              {"ru": "— не обязательно",             "en": "— optional",                 "de": "— optional"},
    "Pircējs var nopirkt uzreiz bez solīšanas.": {"ru": "Покупатель может купить сразу без торгов.", "en": "Buyer can purchase immediately without bidding.", "de": "Käufer kann sofort ohne Bieten kaufen."},
    "Rezerves cena (€)":           {"ru": "Резервная цена (€)",           "en": "Reserve price (€)",          "de": "Mindestpreis (€)"},
    "Slēptā min. cena. Pircēji neredz summu, tikai statusu.": {"ru": "Скрытая мин. цена. Покупатели не видят сумму, только статус.", "en": "Hidden minimum price. Buyers see only the status, not the amount.", "de": "Versteckter Mindestpreis. Käufer sehen nur den Status, nicht den Betrag."},
    "Kontaktinformācija":          {"ru": "Контактная информация",        "en": "Contact information",        "de": "Kontaktinformationen"},
    "Tālrunis redzams sludinājumā pēc pogas nospiešanas. E-pasts nav publiski redzams.": {"ru": "Телефон виден в объявлении после нажатия кнопки. E-mail не является публичным.", "en": "Phone is visible in the listing after button click. Email is not publicly visible.", "de": "Telefon ist im Inserat nach Klick sichtbar. E-Mail ist nicht öffentlich sichtbar."},
    "Publicēšanas ilgums":         {"ru": "Срок публикации",              "en": "Listing duration",           "de": "Veröffentlichungsdauer"},
    "Pēc termiņa sludinājums tiks automātiski dzēsts. Termiņu var pagarināt jebkurā laikā.": {"ru": "По истечении срока объявление будет автоматически удалено. Срок можно продлить в любое время.", "en": "After the period expires, the listing will be automatically deleted. The period can be extended at any time.", "de": "Nach Ablauf der Frist wird die Anzeige automatisch gelöscht. Die Frist kann jederzeit verlängert werden."},
    "Atlaižu kods":                {"ru": "Код скидки",                   "en": "Discount code",              "de": "Rabattcode"},
    "Pārbaudīt":                   {"ru": "Проверить",                    "en": "Check",                      "de": "Prüfen"},
    "TOP vieta":                   {"ru": "ТОП место",                    "en": "TOP spot",                   "de": "TOP-Platz"},
    "Jūsu sludinājums rādīsies saraksta augšgalā, līdz kāds cits samaksā par TOP vietu.": {"ru": "Ваше объявление будет отображаться в верхней части списка, пока кто-то другой не заплатит за ТОП место.", "en": "Your listing will appear at the top of the list until someone else pays for a TOP spot.", "de": "Ihre Anzeige erscheint oben in der Liste, bis jemand anderes für einen TOP-Platz bezahlt."},
    "Lūdzu izvēlieties kategoriju pirms publicēšanas.": {"ru": "Пожалуйста, выберите категорию перед публикацией.", "en": "Please select a category before posting.", "de": "Bitte wählen Sie vor der Veröffentlichung eine Kategorie aus."},
    "E-pasts":                     {"ru": "Эл. почта",                    "en": "Email",                      "de": "E-Mail"},
    "vismaz 1, max 8":             {"ru": "минимум 1, макс. 8",           "en": "at least 1, max 8",          "de": "mindestens 1, max. 8"},
    "nav obligāts, max 1":         {"ru": "не обязательно, макс. 1",      "en": "optional, max 1",            "de": "optional, max. 1"},
    # ── Baneris ──
    "Publicēt reklāmas baneri":    {"ru": "Опубликовать рекламный баннер", "en": "Publish ad banner",          "de": "Werbebanner veröffentlichen"},
    "Par baneri":                  {"ru": "О баннере",                    "en": "About the banner",           "de": "Über das Banner"},
    "Baneris rādīsies visās lapas apakšlapās augšējā labajā stūrī": {"ru": "Баннер будет отображаться на всех страницах сайта в верхнем правом углу.", "en": "The banner will appear on all pages in the top-right corner.", "de": "Das Banner erscheint auf allen Seiten oben rechts."},
    "Rotācijas laiks:":            {"ru": "Время ротации:",               "en": "Rotation time:",             "de": "Rotationszeit:"},
    "sek. katram banerim":         {"ru": "сек. для каждого баннера",     "en": "sec. per banner",            "de": "Sek. pro Banner"},
    "Maksa:":                      {"ru": "Стоимость:",                   "en": "Fee:",                       "de": "Gebühr:"},
    "novilkts no maka":            {"ru": "списывается с кошелька",       "en": "deducted from wallet",       "de": "vom Wallet abgezogen"},
    "Bezmaksas":                   {"ru": "Бесплатно",                    "en": "Free",                       "de": "Kostenlos"},
    "Ieteicamais izmērs:":         {"ru": "Рекомендуемый размер:",        "en": "Recommended size:",          "de": "Empfohlene Größe:"},
    "Banera attēls":               {"ru": "Изображение баннера",          "en": "Banner image",               "de": "Bannerbild"},
    "JPG, PNG, WEBP. Ieteicamais izmērs: 300×150 px.": {"ru": "JPG, PNG, WEBP. Рекомендуемый размер: 300×150 пx.", "en": "JPG, PNG, WEBP. Recommended size: 300×150 px.", "de": "JPG, PNG, WEBP. Empfohlene Größe: 300×150 px."},
    "Priekšskatījums:":            {"ru": "Предпросмотр:",                "en": "Preview:",                   "de": "Vorschau:"},
    "Teksts":                      {"ru": "Текст",                        "en": "Text",                       "de": "Text"},
    "nav obligāts — rakstāmmašīnas efekts": {"ru": "не обязательно — эффект печатной машинки", "en": "optional — typewriter effect", "de": "optional — Schreibmaschineneffekt"},
    "Teksts animēti parādīsies zem attēla.": {"ru": "Текст анимированно появится под изображением.", "en": "The text will animate below the image.", "de": "Der Text wird animiert unter dem Bild erscheinen."},
    "Saite pēc klikšķa":          {"ru": "Ссылка по клику",              "en": "Link on click",              "de": "Link beim Klick"},
    "Publicēt baneri":             {"ru": "Опубликовать баннер",          "en": "Publish banner",             "de": "Banner veröffentlichen"},
    "Vēlaties publicēt reklāmas baneri?": {"ru": "Хотите опубликовать рекламный баннер?", "en": "Want to publish an ad banner?", "de": "Möchten Sie einen Werbebanner veröffentlichen?"},
    "Baneris parādīsies visās lapas apakšlapās augšējā labajā stūrī.": {"ru": "Баннер появится на всех страницах сайта в верхнем правом углу.", "en": "The banner will appear on all pages in the top-right corner.", "de": "Das Banner erscheint auf allen Seiten oben rechts."},
    "Publicēt baneri":             {"ru": "Опубликовать баннер",          "en": "Publish banner",             "de": "Banner veröffentlichen"},

    "1 nedēļa":                    {"ru": "1 неделя",                     "en": "1 week",                     "de": "1 Woche"},
    "2 nedēļas":                   {"ru": "2 недели",                     "en": "2 weeks",                    "de": "2 Wochen"},
    "3 nedēļas":                   {"ru": "3 недели",                     "en": "3 weeks",                    "de": "3 Wochen"},
    "4 nedēļas":                   {"ru": "4 недели",                     "en": "4 weeks",                    "de": "4 Wochen"},
}

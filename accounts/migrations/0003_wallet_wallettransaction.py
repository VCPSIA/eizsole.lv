...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0002_profile_email_verified_profile_phone_verified_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tx_type', models.CharField(choices=[('deposit', 'Iemaksa'), ('spend', 'Tēriņš'), ('refund', 'Atmaksa')], max_length=10)),
